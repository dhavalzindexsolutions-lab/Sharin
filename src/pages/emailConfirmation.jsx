                        ...
                        <div className="flex flex-col gap-5 justify-between w-full">
                            ...
                            <div className="block max-w-[500px] w-full mx-auto py-8 lg:py-12 px-4">
                                <div className="flex flex-col justify-center text-left h-full">
                                    ...
                                    <div className="block font-black text-2xl text-black mb-2 -tracking-[0.02em]">
                                        <span>Verifica il tuo indirizzo email</span>
                                    </div>

                                    {/* verifyEmailAddress */}
                                    <div className="block font-normal text-16 text-black -tracking-[0.02em]">
                                        <p>Verifica il tuo indirizzo email cliccando sul seguente link.</p>
                                    </div>

                                    {/* Resend Buttons */}
                                    <div className="flex gap-3 py-8">
                                        <Button size="auto" variant="accent">
                                        Verifica l’indirizzo email
                                        </Button>
                                    </div>

                                    {/* verifyEmailAddress */}
                                    <div className="flex flex-wrap flex-col gap-8 font-normal text-sm text-subduded-500 -tracking-[0.02em]">
